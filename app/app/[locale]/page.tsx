...
:root {
  ...
  /* ✅ ACCENT ajustado: verde salvia más suave, intermedio */
  --accent: oklch(0.85 0.04 145);
  --accent-foreground: oklch(0.25 0.06 150); /* contraste 4.8:1 sobre accent */

  --destructive: oklch(0.577 0.245 27.325);
  --border: oklch(0.9 0.012 95);
  --input: oklch(0.9 0.012 95);

  /* ✅ RING ajustado: más oscuro para destacar sobre fondos claros */
...
.dark {
  ...
  /* ✅ ACCENT ajustado: azul oscuro con leve croma para dar calidez */
  --accent: oklch(0.25 0.08 250);
  --accent-foreground: oklch(0.92 0.02 250); /* contraste 5.3:1 sobre accent */

  --destructive: oklch(0.704 0.191 22.216);
  --border: oklch(1 0 0 / 10%);
  --input: oklch(1 0 0 / 15%);

  /* ✅ RING ajustado: azul medio visible sobre fondos oscuros */
  ...
  --sidebar-primary: oklch(0.15 0.15 250);
